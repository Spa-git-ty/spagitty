...
Early. The application chrome and the Graph, Diff, Working copy and Branches
screens are implemented; the remaining screens are placeholders being built one
at a time.
