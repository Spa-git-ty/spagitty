...
//! is evidence.
//!
//! **Reads are absent on purpose.** Almost everything GitLord does — walking
...
//! `git log` GitLord never ran would teach the user an invocation that does not
...
mod tests {
    ...
    fn a_password_in_a_clone_url_is_replaced() {
        assert_eq!(
            redact("https://maxmya:ghp_secret@github.com/maxmya/gitlord.git"),
            "https://maxmya:***@github.com/maxmya/gitlord.git"
        );
    }
    ...
    fn a_url_without_credentials_is_left_exactly_as_it_was() {
        for url in [
            "https://github.com/maxmya/gitlord.git",
            "git@github.com:maxmya/gitlord.git",
            "ssh://git@github.com/maxmya/gitlord.git",
            "/home/maxmya/Dev/mywrok/gitlord",
            "--force-with-lease",
        ] {
