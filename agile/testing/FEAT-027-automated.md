...
| Test | Asserts |
| --- | --- |
| `keeps saying which program this is, whatever is open` | The bar shows "Spagitty" even with a repository open — the name and branch moved to the toolbar and the tab |
