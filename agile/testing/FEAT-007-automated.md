...
| `crates/spagitty-core/src/search.rs` | 94.76% | — | 88.10% | 96.39% |
| `crates/spagitty-core/src/blame.rs` | 95.68% | — | 83.72% | 95.86% |
...
now, since Spagitty and `git blame` are the same program.
