...
- **Steps:** Put the GitLord pane and `git show <sha>` side by side.
...
- **Steps:** Close GitLord, reopen it, open any diff.
...
- **Priority:** P2
- **Preconditions:** GitLord running with a repository open.
