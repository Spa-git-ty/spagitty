...
## Rust Backend Tests (`crates/spagitty-core/src/forge/review.rs`)
...
- `mounts and renders PR header, accordion panes, and controls`: Validates UI mounting, accordions, and view toggling.
- `opens and closes review modal in reviewer mode`: Validates review modal lifecycle.
