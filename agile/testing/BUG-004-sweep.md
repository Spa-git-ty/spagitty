...
- **Priority:** P2
- **Steps:** `WEBKIT_DISABLE_DMABUF_RENDERER=1 ./GitLord.AppImage`
...
- **Priority:** P1
- **Steps:** `WEBKIT_DISABLE_DMABUF_RENDERER=0 ./GitLord.AppImage`
...
- **Priority:** P2
- **Steps:** `npm run tauri dev -- -- -- /tmp/gitlord-fixture`, with no
